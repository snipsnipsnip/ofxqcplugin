...
For example, if we have two Quartz Composer plugins that both have ofBaseApp implementations named 'testApp' that do different things (ie, draw different graphics), if both Quartz Composer plugins are loaded its undefined which testApp implementation is used. You will get one of them in instances of your different plugins, and things will break or behave in very odd ways and you will slowly go insane.
